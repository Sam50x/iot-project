...
export default function Home() {
  ...
  return (
    <div className="font-sans flex flex-col items-center justify-center min-h-screen w-full">
      <div className="w-100 h-12 bg-white flex justify-start items-start">
        <div className="h-12 bg-red-500 flex justify-start items-start" style={{ width: barWidth }}>
        </div>
      </div>
